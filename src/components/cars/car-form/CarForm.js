...
export function CarForm(props) {
    ...
    <div className="car-form-wrapper">
            ...
            <Form.Group className="mb-3" controlId="name">
                ...
                <Form.Control type="text" name="brand" value={car.brand} placeholder="Enter Brand" onChange={onInputChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="name">
                <Form.Label>Model</Form.Label>
                <Form.Control type="text" name="model" value={car.model} placeholder="Enter Model" onChange={onInputChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="constructionYear">
                <Form.Label>Construction Year</Form.Label>
                <Form.Control type="date" name="constructionYear" value={car.constructionYear} placeholder="Enter constructionYear" onChange={onInputChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="status">
                    <Form.Label>Type</Form.Label>
                    <Form.Select placeholder="Select Status" name="type" value={car.type} onChange={onInputChange}> 
                        { Object.keys(carTypes).map(type => <option key={type} value={carTypes[type]}>{carTypes[type]}</option>)}
                    </Form.Select>
            </Form.Group>
            <Form.Group className="mb-3" controlId="status">
            ...
            <Form.Group className="mb-3" controlId="seatsCount">
                ...
                <Form.Control type="number" name="seatsCount" value={car.seatsCount} placeholder="Enter seats count" onChange={onInputChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="pricePerDay">
                <Form.Label>Price per day</Form.Label>
                <Form.Control type="number" name="pricePerDay" value={car.pricePerDay} placeholder="Enter price per day" onChange={onInputChange}/>
            </Form.Group>
